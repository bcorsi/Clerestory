    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal modal-lg" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          {/* Location */}
          <div style={{  fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.04em', color: 'var(--text-muted)', marginBottom: '10px' }}>Location</div>
          ...
          {/* Deal Terms */}
          <div style={{  fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.04em', color: 'var(--text-muted)', marginTop: '16px', marginBottom: '10px' }}>Deal Terms</div>
          ...
          {/* Expenses */}
          <div style={{  fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.04em', color: 'var(--text-muted)', marginTop: '16px', marginBottom: '10px' }}>Expenses ($/SF/Mo)</div>
          <div className="form-row-3">
            <div className="form-group">
          ...
          {form.rate && totalExpenses > 0 && (
            <div style={{ display: 'flex', gap: '20px', padding: '10px 14px', background: 'var(--bg-input)', borderRadius: 'var(--radius-sm)', marginBottom: '14px',  }}>
          ...
          {/* Parties */}
          <div style={{  fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.04em', color: 'var(--text-muted)', marginTop: '8px', marginBottom: '10px' }}>Parties & Source</div>
          <div className="form-row-3">
            <div className="form-group">
          ...
          {/* Building */}
          <div style={{  fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.04em', color: 'var(--text-muted)', marginTop: '8px', marginBottom: '10px' }}>Building Info (optional)</div>
          <div className="form-row-3">
            <div className="form-group">
