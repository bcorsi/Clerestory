  ...
  return (
    <div style={{ maxWidth: '600px' }}>
      ...
      <div className="card mb-6">
        <div style={{  fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.04em', color: 'var(--text-muted)', marginBottom: '16px' }}>Profile</div>
        ...
        <div className="form-group">
          ...
          <div style={{  color: 'var(--text-muted)', marginTop: '4px' }}>Email cannot be changed here</div>
        </div>
      ...
      {/* Change Password */}
      <div className="card mb-6">
        <div style={{  fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.04em', color: 'var(--text-muted)', marginBottom: '16px' }}>Change Password</div>
      ...
      {/* App Info */}
      <div className="card">
        <div style={{  fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.04em', color: 'var(--text-muted)', marginBottom: '16px' }}>About</div>
