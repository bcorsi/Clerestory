...
export function getScoreRing(score) {
  if (score >= 90) return { color: '#B83714', grade: 'A+' };
  if (score >= 80) return { color: '#B83714', grade: 'A'  };
  if (score >= 70) return { color: '#4E6E96', grade: 'B+' };
  if (score >= 60) return { color: '#4E6E96', grade: 'B'  };
  if (score >= 50) return { color: '#8C5A04', grade: 'C+' };
  return { color: '#78726A', grade: 'C' };
}
