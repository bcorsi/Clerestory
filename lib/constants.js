...
// ─── MARKETS & SUBMARKETS ────────────────────────────────────
export const MARKETS = ['SGV', 'IE', 'LA', 'South Bay', 'Mid-Counties', 'OC', 'Ventura'];
...
export const LEAD_STAGE_COLORS = {
  'Lead':                       '#6b7280',
  'Decision Maker Identified':  '#8b5cf6',
  'Contact Info Found':         '#f59e0b',
...
export const STAGE_COLORS = {
  'Tracking':          '#3b82f6',
  'Underwriting':      '#8b5cf6',
  'Off-Market Outreach':'#a855f7',
  'Marketing':         '#f59e0b',
  'LOI':               '#f97316',
  'LOI Accepted':      '#ef4444',
  'PSA Negotiation':   '#ec4899',
  'Due Diligence':     '#d946ef',
  'Non-Contingent':    '#10b981',
  'Closed (Won)':      '#22c55e',
  'Closed (Lost)':     '#6b7280',
  'Dead':              '#374151',
};
...
export const LEAD_SUBSTEPS = {
  ...
  'Decision Maker Identified': [
    ...
    'Research background (LinkedIn, news)',
    'Find contact info (phone/email)',
  ],
  'Contact Info Found': [
    'Verify phone number active',
    'Verify email deliverable',
    'Prepare outreach script/template',
    'Log contact info in record',
  ],
  'Owner Contacted': [
    'Left voicemail',
...
export const WARN_CITIES = [
  ...
  // LA County
  'Commerce', 'Los Angeles', 'Santa Clarita', 'Palmdale', 'Lancaster',
  // South Bay
  'Carson', 'Torrance', 'Compton', 'Gardena', 'Hawthorne', 'Inglewood',
  'Lynwood', 'South Gate', 'Bell Gardens', 'Long Beach', 'El Segundo',
  // Mid-Counties
  'Whittier', 'La Mirada', 'Cerritos', 'Artesia', 'Norwalk', 'Pico Rivera',
  'Buena Park', 'La Palma', 'Paramount', 'Downey',
  // OC
